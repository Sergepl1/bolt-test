/*
  ...
  1. New Tables
    - `listings`
      - Core table for marketplace listings
      - Supports both fixed price and auction listings
      - Includes location data and listing options
    - `listing_images`
      - Stores images for listings with position ordering
      - Supports featured image flag
    - `listing_views`
      - Tracks listing view statistics
      - Anonymous and authenticated views
    - `listing_favorites`
      - User favorites/watchlist functionality
    - `listing_drafts`
      - Autosave functionality for listing creation
